...
# MTU=1500 (IPv4): max UDP payload = 1472 bytes
# Our header is 11 bytes, so max data payload = 1472 - 11 = 1461
CHUNK_SIZE = 1461
...
def main():
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as sock:
        ...
        print(f"Average datarate: {datarate:.2f} Mb/s")
